    ...
    <div className="bg-white-400 mx-auto mt-5 mb-5 inline-block max-w-6xl border-b-2 p-2 p-8">
      ...
      <Link href={`/link`}>
        <div className="group p-4">
          <h1 className="text-gray-500 flex justify-start text-3xl font-bold">
            Post Title
          </h1>
          <div className="flex">
      ...
      <div>
       <div className='w-24 min-w-full hover:min-w-0 bg-yellow-400'>
         <p>git clone git@bitbucket.org:synthesis_admin/onetest.git</p>
       </div>
      </div>
    </div>
  )
