...
function PostCard({post} : Post | any) {
  ...
  console.log('source image: ', post.mainImage.asset._ref)
  return (
      ...
      <div className="flex">
        ...
        <div className="items-center gap-2 p-2">
          ...
          <p className="text-grey-600 flex justify-end text-xs">
            <span>Created at &nbsp;</span> {post?._createdAt.split('T')[0]}
          </p>
        </div>
      </div>
        ...
        <div className="group p-4">
          ...
          <div className="flex">
            ...
            <img
              ...
              src={urlFor(post.mainImage?.assert?._ref ? post.mainImage.asset._ref : MediumLogo).url()}
            />
          </div>
        </div>
      </Link>
