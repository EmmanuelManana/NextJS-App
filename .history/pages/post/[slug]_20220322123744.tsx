    ...
    <main>
      ...
      <form className="mx-auto mb-10 flex max-w-2xl flex-col p-5">
        ...
        <label className="mb-5 block">
          ...
          <input
            className="form-input ouline-none mt-1 block w-full rounded border py-2
          px-3 shadow ring-yellow-500 focus:ring"
        ...
        <label className="mb-5 block">
          <span className="text-gray-700">Name</span>
          <input
            className="form-input outline-none mt-1 block w-full rounded border py-2
          px-3 shadow ring-yellow-500 focus:ring"
            placeholder="John Doe"
          />
        </label>
        ...
        <label className="mb-5 block">
          ...
          w-full focus:ring ring-yellow-500 outline-none'
          
          placeholder="Leave a comment..." rows={8} />
        </label>
      </form>
    </main>
  )
