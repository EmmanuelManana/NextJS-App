    ...
    <main>
      ...
      <form className="mx-auto mb-10 flex max-w-2xl flex-col p-5">
        ...
        <div  className='flex flex-col p-5'>
          {errors.name && (<span className='text-red-500'>- Name fiels is required.</span>)}
          {errors.email && (<span className='text-red-500'>- E-mail fiels is required.</span>)}
          {errors.comment && (<span className='text-red-500'>- Comment fiels is required.</span>)}
        </div>

        <input className='shadow bg-yellow-500 hover:bg-yellow-400' type="submit" />
